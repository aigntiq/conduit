...
[`aigntiq`](https://github.com/aigntiq) org. It uses a shared working setup —
agent guide, git-worktree workflow, CI/release pipeline, and protected `main`.
...
See [`AGENTS.md`](./AGENTS.md) for the full worktree workflow (it's the same for
...
- **Update docs in the same PR.** Package/script/API changes update the in-repo docs (see `AGENTS.md` → Documentation).
