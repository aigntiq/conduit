    ...
    "operations": [
        ...
        },
        {
            ...
            "inputs": {
                ...
                "x-rules": [
                    {
                        "check": "{{ !isEmpty(inputs.givenName) || !isEmpty(inputs.familyName) || !isEmpty(inputs.emails) || !isEmpty(inputs.phones) || !isEmpty(inputs.organization) || !isEmpty(inputs.jobTitle) || !isEmpty(inputs.address) || !isEmpty(inputs.birthday) || !isEmpty(inputs.notes) }}",
