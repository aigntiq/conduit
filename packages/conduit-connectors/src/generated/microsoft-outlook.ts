    ...
    "operations": [
        ...
        },
        {
            ...
            "request": {
                ...
                "url": "/me/messages/{{urlEncode(inputs.messageId)}}{{inputs.replyAll ? '/replyAll' : '/reply'}}"
            }
        },
        {
            "id": "forward-message",
            ...
            "request": {
                ...
                "url": "/me/messages/{{urlEncode(inputs.messageId)}}/forward"
            }
        },
        {
            "id": "search-messages",
            ...
            "request": {
                ...
                "url": "{{isEmpty(inputs.folderId) ? '/me/messages' : '/me/mailFolders/' + urlEncode(inputs.folderId) + '/messages'}}"
            },
            "paginate": {
                "style": "nextUrl",
                "maxPages": 20,
        ...
        },
        {
            ...
            "request": {
                ...
                "url": "/me/messages/{{urlEncode(inputs.id)}}"
            }
        },
        {
            "id": "get-attachment",
            ...
            "request": {
                "url": "/me/messages/{{urlEncode(inputs.messageId)}}/attachments/{{urlEncode(inputs.attachmentId)}}"
            }
        },
        {
            "id": "list-folders",
        ...
        },
        {
            ...
            "request": {
                ...
                "url": "/me/messages/{{urlEncode(inputs.id)}}/move"
            }
        },
        {
            "id": "update-message",
            ...
            "trigger": {
                ...
                "subscribe": {
                    ...
                    "body": {
                        ...
                        "resource": "me/mailFolders('{{default(inputs.folderId, 'inbox')}}')/messages",
